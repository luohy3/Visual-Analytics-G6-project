...
For tabpanel2, the top line is the selection input of zoom which could enlarge or smaller the map size.Below is a map which plot the clustered point on the map. It would be an necessary part to support users connect gps point with provided location name on the map.
